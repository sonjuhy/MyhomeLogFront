...
const data = [
  {
    ...
    avatar: '/assets/avatars/avatar-spring.png',
  ...
  },
  {
    ...
    avatar: '/assets/avatars/avatar-django.png',
...
export default function Main(){
    ...
    const getLogData = async() => {
        ...
        const getLogData = await sendToSpring("/kafka/findByServicePageReverse/"+service+"/"+page+'/'+rowsPerPage, "GET", "", "");
    ...
    const getDataCount = async() => {
        const getDataCount = await sendToSpring("/kafka/countByService/"+service, "GET", "", "");
