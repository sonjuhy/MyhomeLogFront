...
export default function Main(){
    ...
    const GetTotalTypeCount = async() => {
        const getTotalTypeTrueCount = await sendToSpring("/kafka/countByServiceAndType/reserve/true", "GET", "", "");
        const getTotalTypeFalseCount = await sendToSpring("/kafka/countByServiceAndType/reserve/false", "GET", "", "");
    ...
    const GetLogData = async() => {
        const getLogData = await sendToSpring("/kafka/findByServicePageReverse/reserve/0/10", "GET", "", "");
        var tmpList = [];
    ...
    const GetDaysTypeCount = async() =>{
        ...
        for(let i = 0; i < 10; i++) {
            ...
            const getDayTrue = await sendToSpring("/kafka/countByServiceAndDayAndType/reserve/"+day+"/true", "GET", "", "");
            const getDayFalse = await sendToSpring("/kafka/countByServiceAndDayAndType/reserve/"+day+"/false", "GET", "", "");
